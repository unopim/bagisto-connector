            ...
            <div class="grid gap-2.5 mt-3.5 p-5 max-xl:flex-wrap box-shadow">
                ...
                >
                    ...
                    <div class="grid gap-2">
                        ...
                        <p class="flex gap-2 items-center">
                            <i
                                class="icon-information text-2xl rounded-full text-violet-700"

                            ></i>

                            <span class="text-gray-800 font-medium">
                                @lang('admin::app.settings.data-transfer.imports.import.total-rows-reading-and-validating')
                            </span>
                ...
                methods: {
                    ...
                    getStats() {
                        ...
                        if (this.importResource.state == 'linking')  {
                            ...
                            state = 'indexed';
                        } else if (this.importResource.state == 'validating') {
                            state = 'validating';
                        }
                        ...
                        this.$axios.get("{{ route('admin.settings.data_transfer.imports.stats', $import->id) }}/" + state)
                            .then((response) => {
                                ...
                                if (this.importResource.state !== 'completed'
                                    && (this.importResource.state === 'pending' || this.isValid || this.importResource.state === 'validating' )
                                ) {
                                    setTimeout(() => {
                                        this.getStats();
                                    }, 1000);
