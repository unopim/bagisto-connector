            ...
            'closure'    => function ($row) {
                switch ($row->state) {
                    ...
                    case Import::STATE_VALIDATING:
                            return '<p class="label-info  text-violet-700 bg-violet-200">'.trans('admin::app.settings.data-transfer.tracker.index.datagrid.validating').'</p>';
                    ...
                    case Import::STATE_FAILED:
                        return '<p class="label-canceled">'.trans('admin::app.settings.data-transfer.tracker.index.datagrid.failed').'</p>';
                }
            },
        ]);
