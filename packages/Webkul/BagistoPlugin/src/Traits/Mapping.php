...
trait Mapping
{
     ...
     * @return void
     */
    protected function setMapping(string|int $credentialId, string|int $relatedId, string|int $externalId, string|int $batchId, $entityType = self::ENTITY_TYPE)
    {
        $mapping = $this->getMapping($credentialId, $relatedId, null, null, $entityType);
        if (! $mapping) {
     ...
     */
    protected function getMapping(string|int|null $credentialId = null, string|int|null $relatedId = null, string|int|null $externalId = null, string|int|null $batchId = null, $entityType = self::ENTITY_TYPE)
    {
