<x-admin::layouts.with-history>
    ...
    <x-slot:title>
        @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.title')
    </x-slot>

    <x-admin::form
        :action="route('admin.bagisto_plugin.credentials.update', ['id' => $credential->id])"
    >
        @method('PUT')
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-x-2.5 items-center">
                <a
                    href="{{ route('admin.bagisto_plugin.credentials.index') }}"
                    class="transparent-button"
                >
                    @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.back-btn')
                </a>
                ...
                <button
                    ...
                    aria-lebel="Submit"
                >
                    @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.save-btn')
                </button>
            </div>
        </div>
            ...
            <div class="flex flex-col gap-2 flex-1 max-xl:flex-auto">
                ...
                <div class="p-4 bg-white dark:bg-cherry-900 rounded box-shadow">
                    <p class="text-base text-gray-800 dark:text-white font-semibold mb-4">
                        @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.store-config')
                    </p>
                    <v-store-config
            ...
            <div class="flex flex-col gap-2 w-[360px] max-w-full max-sm:w-full">
                    ...
                    <x-slot:header>
                        <div class="flex items-center justify-between">
                            <p class="p-2.5 text-gray-800 dark:text-white text-base  font-semibold">
                                @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.general')
                            </p>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label class="required">
                                @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.shop_url')
                            ...
                            <x-admin::form.control-group.control
                                ...
                                rules="required"
                                readonly
                                :label="trans('bagisto_plugin::app.bagisto-plugin.credentials.edit.shop_url')"
                                :placeholder="trans('bagisto_plugin::app.bagisto-plugin.credentials.edit.shop_url')"
                            />
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label class="required">
                                @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.email')
                            </x-admin::form.control-group.label>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                rules="required"
                                :label="trans('bagisto_plugin::app.bagisto-plugin.credentials.edit.email')"
                                :placeholder="trans('bagisto_plugin::app.bagisto-plugin.credentials.edit.email')"
                            />
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label class="required">
                                @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.password')
                            </x-admin::form.control-group.label>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                rules="required"
                                :label="trans('bagisto_plugin::app.bagisto-plugin.credentials.edit.password')"
                                :placeholder="trans('bagisto_plugin::app.bagisto-plugin.credentials.edit.password')"
                            />
                ...
                <x-admin::accordion>
                    <x-slot:header>
                        <div class="flex items-center justify-between">
                            <p class="p-2.5 text-gray-800 dark:text-white text-base  font-semibold">
                                @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.category-field-mapping')
                            </p>
                        </div>
                    </x-slot>
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label class="required">
                                @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.category-field-filterable')
                            </x-admin::form.control-group.label>
                            @php
                ...
                >
                    <div>
                        <p class="col-span-1 text-sm font-bold text-gray-800 dark:text-white">
                            @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.bagisto-channel')
                        </p>
                    </div>
                    <div class="text-left">
                        <p class="text-sm font-bold text-gray-800 dark:text-white">
                            @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.unopim-channel')
                        </p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div>
                        ...
                        >
                            <div>
                                <p class="col-span-1 text-sm font-bold text-gray-800 dark:text-white">
                                    @lang('bagisto_plugin::app.bagisto-plugin.credentials.edit.bagisto-locale')
                                </p>
                            </div>
                            <div class="text-left">
                                <p class="text-sm font-bold text-gray-800 dark:text-white">
