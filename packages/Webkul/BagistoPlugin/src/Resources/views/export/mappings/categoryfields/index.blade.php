<x-admin::layouts.with-history>
    ...
    <x-slot:title>
        @lang('bagisto_plugin::app.bagisto-plugin.export.mapping.category-fields.title')
    </x-slot>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex gap-x-2.5 items-center">
                            ...
                            >
                                ...
                                @lang('bagisto_plugin::app.bagisto-plugin.export.mapping.category-fields.save')
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col gap-2 flex-1 max-xl:flex-auto">
                            <div class="p-4 bg-white dark:bg-cherry-900 rounded box-shadow">
                                <div class="grid grid-cols-3 gap-10 items-center px-4 py-2.5 border-b bg-violet-50 dark:border-cherry-800 dark:bg-cherry-900 font-semibold">
                                    <p class="break-words font-bold dark:text-slate-50 font-bold">@lang('bagisto_plugin::app.bagisto-plugin.export.mapping.category-fields.bagisto-fields')</p>
                                    <p class="break-words font-bold dark:text-slate-50 font-bold">@lang('bagisto_plugin::app.bagisto-plugin.export.mapping.category-fields.unopim-category-fields')</p>
                                    <p class="break-words font-bold dark:text-slate-50 font-bold">@lang('bagisto_plugin::app.bagisto-plugin.export.mapping.category-fields.fixed-value')</p>
                                </div>
                                ...
                                >
                                    <p :title="bagostoField.title" class="break-words items-center">@{{ bagostoField.name }} [@{{ bagostoField.code }}] <span class="required" v-if="bagostoField.required"></span></p>
                                    ...
                                    <x-admin::form.control-group class="!mb-0">
                                        <x-admin::form.control-group.control
                                            ...
                                            ::value="selectMappedStandardCategoryFieldDefault(bagostoField.code)"
                                            ::label="bagostoField.name"
                                            ::placeholder="bagostoField.name"
            ...
            app.component('v-category-field-mapping', {
                ...
                methods: {
                    ...
                    getFieldsByType(bagistoField) {
                        return this.categoryFields.filter(field => {
                            if (bagistoField.unique) {
                                return field.is_unique && field.type === bagistoField.type;
                            }

                            return  field.type === bagistoField.type
                        });
                    },
                    ...
                    storeCategoryFieldMapping(params, { resetForm, setErrors  }) {
                        ...
                        this.$axios.post("{{ route('admin.bagisto_plugin.mappings.category_fields.store') }}", formData)
                        .then((response) => {
