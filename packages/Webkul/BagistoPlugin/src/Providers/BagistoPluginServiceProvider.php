...
class BagistoPluginServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        Route::middleware('web')->group(__DIR__.'/../Routes/bagisto-plugin-routes.php');

        $this->loadMigrationsFrom(__DIR__.'/../Database/Migrations');

        $this->loadViewsFrom(__DIR__.'/../Resources/views', 'bagisto_plugin');
        $this->loadTranslationsFrom(__DIR__.'/../Resources/lang', 'bagisto_plugin');

        Event::listen('unopim.admin.layout.head', function ($viewRenderEventManager) {
            $viewRenderEventManager->addTemplate('bagisto_plugin::style');
        });
